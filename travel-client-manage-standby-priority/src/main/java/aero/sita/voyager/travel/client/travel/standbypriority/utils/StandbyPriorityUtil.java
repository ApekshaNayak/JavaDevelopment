 ...
 * All rights reserved.
 */
package aero.sita.voyager.travel.client.travel.standbypriority.utils;
...
import aero.sita.voyager.travel.client.travel.standbypriority.listeners.CancelDescriptionListener;
import aero.sita.voyager.travel.client.travel.standbypriority.listeners.SaveDescriptionListener;
...
/**
 * <pre>
 * <b>Description : </b> Util class for Standby Priority.
 * 
...
public class StandbyPriorityUtil {
     ...
     * Label.
     */
    private static final String LABEL_VALUE = "Priority code ";
    /**
     * Description.
     */
     ...
     * <pre>
    * <b>Description : </b>
    * Constructs an instance of 'StandbyPriorityUtil'.
    *
    * </pre>
     */
    ...
    public StandbyPriorityUtil(final Frame parentFram, final String description, final String priorityCode,
        final StandbyPriorityController controllerInstance, final int selectedRow) {
    ...
    private void createPriorityPanel(final String description, final String priorityCode) {
        ...
        final JLabel priorityLabelName = new JLabel(LABEL_VALUE + priorityCode);
        ...
        // Main Panel Creation.
        mainPanel.setLayout(new FormLayout("4dlu,pref,4dlu", "2dlu,pref,2dlu"));
     ...
     * This will be the title of the dialog box.
     * @param customisedMsg , not null.
     * @return option , never null.
     * This is the customised message to be displayed on the confirmation box.
     * </pre>
     */
    public int confirmDelete(final String title, final String customisedMsg) {
        StandbyPriorityUtil.LOGGER.debug("Entered StandbyPriorityUtil.confirmDelete");
        ...
        StandbyPriorityUtil.LOGGER.debug("Exited StandbyPriorityUtil.confirmDelete");
        return option;
    }
     ...
     * @param title , not null.
     * Parent frame from the NGAF.
     * @param customisedMsg , not null.
     * @return customisedMsg , never null.
     * </pre>
     */
    private static int createOptionForConfirmation(final JFrame parentFrame, final String title,
        final String customisedMsg) {
        StandbyPriorityUtil.LOGGER.debug("Entered StandbyPriorityUtil.createOptionForConfirmation");
        ...
        StandbyPriorityUtil.LOGGER.debug("Exited StandbyPriorityUtil.createOptionForConfirmation");
     ...
     * </pre>
     */
    // public void marshallDTOToXML(final Object beanToMarshall, final Class
    // marshallType) {
    // StandbyPriorityUtil.LOGGER.info("marshallDTOToXML entry");
    //
    ...
    // IMarshallingContext marshalCtx =
    ...
    //
    // StandbyPriorityUtil.LOGGER.info(resWriter);
    // marshalCtx.marshalDocument(beanToMarshall, null, null, resWriter);
    // }
    // catch (BeansException ex) {
    // // ex.printStackTrace();
    // StandbyPriorityUtil.LOGGER.error(ex);
    // }
    ...
    // }
    //
    // StandbyPriorityUtil.LOGGER.info("marshallDTOToXML exit");
    // }
     ...
     * </pre>
     */
    // public Object unMarshallXMLToDTO(final Class marshallType, String
    // inputFileNameParam) {
    // StandbyPriorityUtil.LOGGER.debug("unMarshallXMLToDTO entry");
    //
    // Object object = null;
    ...
    // }
    //
    // StandbyPriorityUtil.LOGGER.debug("inputFileName " + inputFileNameParam);
    //
    // bindingFactory = BindingDirectory.getFactory(marshallType);
    // IUnmarshallingContext unMarshalCtx =
    ...
    // }
    //
    // StandbyPriorityUtil.LOGGER.debug("unMarshallXMLToDTO exit");
    //
    // return object;
    // }
