 ...
 * </pre>
 */
public class ResetDefaultStandbyPriorityListener implements ActionListener {
    /**
     * Logger instance for the class.
     */
    private static final SITAGUILogger LOGGER = SITAGUILoggerFactory
    .getLogger(ResetDefaultStandbyPriorityListener.class);
    /**
    ...
    public final void actionPerformed(final ActionEvent actionEvent) {
        ResetDefaultStandbyPriorityListener.LOGGER.info("Enter ResetDefaultStandbyPriorityListener:actionPerformed()");
        
        DcsMessagePanelHandler.clearAllMessages();
        
        ResetDefaultStandbyPriorityListener.LOGGER.info("Exit ResetDefaultStandbyPriorityListener:actionPerformed()");
    }
