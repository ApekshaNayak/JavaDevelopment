 ...
 * <pre>
 * <b>Description : </b>
 * This class is for New Standby Priority Description Save Button Action Listener.
 * 
...
public class SaveDescriptionListener implements ActionListener {
    ...
    .getLogger(SaveDescriptionListener.class);
    /**
     * THREE.
     */
    ...
    public final void actionPerformed(final ActionEvent actionEvent) {
        SaveDescriptionListener.LOGGER
        .info("Enter SaveDescriptionListener:actionPerformed()");
        DcsMessagePanelHandler.clearAllMessages();

        boolean isValid;
        final StandbyPriorityDetailsValidator standbyPriorityDetailsValidator = new StandbyPriorityDetailsValidator();

        final DefaultTableModel defaultTableModel = (DefaultTableModel) controller
        ...
        isValid = standbyPriorityDetailsValidator.validatePriorityStatusDesc(
            priorityTextArea.getText().toString(), defaultSPStandardTable);

        if (isValid) {
            defaultTableModel.setValueAt(priorityTextArea.getText(),
                selectedRow, THREE);
            priorityDialogBox.dispose();
        }

        SaveDescriptionListener.LOGGER
        .info("Exit SaveDescriptionListener:actionPerformed()");
    }
    ...
    public final void setController(
        final StandbyPriorityDetailsController controllerParam) {
